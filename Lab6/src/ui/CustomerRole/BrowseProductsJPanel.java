...
public class BrowseProductsJPanel extends javax.swing.JPanel {
   ...
   Order currentOrder;
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Please check the price and quantity first!");
        return;
        }
        ...
        JOptionPane.showMessageDialog(this, "Please check productavailability!!");
        return;
        }
    ...
    private void populateProductTable() {
        ...
        for (Product p : selectSupplier.getProductCatalog().getProductcatalog()) {
